    ...
    <AuthLayout>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit((data) => loginMutation.mutate(data))} className="space-y-5">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input type="email" placeholder="you@example.com" autoComplete="email" autoFocus className="h-12 rounded-xl text-base" data-testid="input-email" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
              ...
              <FormItem>
                ...
                <FormControl>
                  <div className="relative">
                    <Input type={showPassword ? "text" : "password"} placeholder="Enter your password" autoComplete="current-password" className="h-12 rounded-xl text-base pr-12" data-testid="input-password" {...field} />
          ...
          <Button type="submit" className="w-full h-12 rounded-xl text-base font-semibold active:scale-[0.98] transition-all duration-200" disabled={loginMutation.isPending} data-testid="button-login">
      ...
      <div className="mt-10 pt-6 border-t border-border/40">
        <p className="text-sm text-muted-foreground text-center">
          New to OBT Mentor Companion?{" "}
          <Link href="/signup" className="text-primary font-medium hover:underline" data-testid="link-signup">Create an account</Link>
        </p>
      </div>
    </AuthLayout>
  );
